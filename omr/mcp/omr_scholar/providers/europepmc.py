"""Europe PMC provider -- POST-MVP STUB.
...
empty result set with a post-MVP note rather than raising, so a caller
that explicitly opts in degrades gracefully instead of crashing.
"""
...
NAME = "europepmc"
POST_MVP = True
_NOTE = "europepmc provider is post-MVP: not implemented in the MVP build"
